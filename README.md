...
| INCLUDE_PREVIOUS_MONTH | Indicates whether to collect and export previous month data. Default is false. Setting this flag will allow collecting and uploading the partial data from previous month. For example: If kubecost was installed on Sept 15 and the flag is set to true, then in October we will also load partial data for September.                                                                                                                                                                                   |
