...
flag to false
will prevent collecting and uploading the data from previous month and only upload data for the current month. Partial Data (some days are missing) for previous months will be ignored even if the flag value is true.|
