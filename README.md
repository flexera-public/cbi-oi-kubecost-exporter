...
| INCLUDE_PREVIOUS_MONTH | Indicates whether to collect and export previous month. Default is false. This flag supports the use case where a free version of Kubecost was used and to avoid overwrites of full month data with partial data due to limited history (15 days) retained by free version. For example: If kubecost was installed on Sept 15, then in October we will not load data for September.                                                                                                                                                                                    |
