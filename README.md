...
| INCLUDE_PREVIOUS_MONTH | Indicates whether to collect and export previous month data. Default is true. Indicates whether to collect and export previous month data. Default is true. Setting this flag to false will prevent collecting and uploading the data from previous month and only upload data for the current month.                                                                                                                                                                     |
