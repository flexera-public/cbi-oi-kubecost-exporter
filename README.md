...
| INCLUDE_PREVIOUS_MONTH | Indicates whether to collect and export previous month. Default is false. This flag supports the use case where a free version of Kubecost was used and to avoid overwrites of full month data with partial data due to limited history (15 days) retained by free version.                                                                                                                                                                                    |
